...
class UpdateSectionRequest extends FormRequest
{
    ...
    {
        return [
            'name_ar' => ['required', 'max:255', 'string', new \App\Rules\UniqueFieldTranslation("sections", "name", 'ar', $this->section)],
            'name_en' => ['required', 'max:255', 'string', new \App\Rules\UniqueFieldTranslation("sections", "name", 'en',$this->section)],
